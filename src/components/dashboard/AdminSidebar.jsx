...
const AdminSidebar = () => {
  ...
  return (
    <div>
      ...
      <button
        className="md:hidden text-white absolute top-4 left-4 z-50"
      ...
      <div
        className={`bg-gray-800 text-white h-screen fixed top-0 left-0 bottom-0 space-y-2 w-64 transition-all duration-300 ease-in-out z-50 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
